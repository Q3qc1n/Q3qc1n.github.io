...
function createtime() {
    ...
    var e = new Date("2024/11/29 17:38:00"),
        t = Math.trunc(234e8 + (now - e) / 1e3 * 17),
        a = (t / 1496e5).toFixed(6),
        o = new Date("2024/11/29 17:38:00"),
    ...
    let c = "";
    c = s < 18 && s >= 9 ?
        `<img class='boardsign' src='https://sourcebucket.s3.ladydaily.com/badge/CN小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由啊！'><br> 
        ...
        `<img class='boardsign' src='https://sourcebucket.s3.ladydaily.com/badge/CN小屋-下班休息咯.svg' title='下班了就该开开心心地玩！'><br> 
         <div style="font-size:13px;font-weight:bold">本站居然运行了 ${r} 天 ${s} 小时 ${l} 分 ${b} 秒 
         <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 
         旅行者 1 号当前距离地球 ${t} 千米，约为 ${a} 个天文单位 🚀</div>`;
